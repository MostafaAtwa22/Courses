...
@Component({
  selector: 'app-instructor-enrollment-summary-table',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './instructor-enrollment-summary-table.component.html',
  styleUrl: './instructor-enrollment-summary-table.component.scss'
})
export class InstructorEnrollmentSummaryTableComponent implements OnChanges {
