...
@Component({
  selector: 'app-instructor-enrollment-chart-card',
  standalone: true,
  imports: [CommonModule, BaseChartDirective],
  templateUrl: './instructor-enrollment-chart-card.component.html',
  styleUrl: './instructor-enrollment-chart-card.component.scss'
})
export class InstructorEnrollmentChartCardComponent implements OnInit, OnChanges {
