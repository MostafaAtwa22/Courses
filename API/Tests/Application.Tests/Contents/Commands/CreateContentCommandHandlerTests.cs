...
namespace Application.Tests.Contents.Commands
{
    public class CreateContentCommandHandlerTests
    {
        ...
        public CreateContentCommandHandlerTests()
        {
            ...
            _handler = new CreateContentCommandHandler(_repoMock.Object, _fileServiceMock.Object, _sectionRepoMock.Object, _videoDurationServiceMock.Object, _attachmentServiceMock.Object, _cacheMock.Object);
        }
