...
namespace Application.Tests.Progress.Command.MarkIncomplete
{
    public class MarkContentIncompleteCommandHandlerTests
    {
        ...
        public MarkContentIncompleteCommandHandlerTests()
        {
            ...
            _handler = new MarkContentIncompleteCommandHandler(
        ...
        public async Task Handle_ShouldMarkIncomplete_WhenEnrolledStudent()
        {
            ...
            var command = new MarkContentIncompleteCommand(dto);
        ...
        public async Task Handle_ShouldThrowForbidden_WhenUserNotStudent()
        {
            ...
            var command = new MarkContentIncompleteCommand(new MarkProgressRequestDto { CourseId = courseId });
        ...
        public async Task Handle_ShouldThrowBadRequest_WhenContentNotInCourse()
        {
            ...
            var command = new MarkContentIncompleteCommand(new MarkProgressRequestDto { ContentId = contentId, CourseId = courseId });
