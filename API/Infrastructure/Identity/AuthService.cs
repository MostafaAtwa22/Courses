...
public class AuthService : IAuthService
{
    ...
    public async Task<AuthResponseDto> GenerateAuthWithRefreshTokenAsync(ApplicationUser user)
    {
        var response = await GetAuthResponseAsync(user);
        var jwtId    = new JwtSecurityTokenHandler().ReadJwtToken(response.Token).Id;

        var refreshToken = GenerateRefreshToken(jwtId);
        await AddAsync(user, refreshToken);
    ...
    public async Task AddAsync(ApplicationUser user, RefreshToken refreshToken)
    {
