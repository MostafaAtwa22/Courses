...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260705164301_RenameCourseDiscountsTable")]
    partial class RenameCourseDiscountsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CourseDiscount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_course_discounts");

                    b.HasIndex("CourseId")
                        .HasDatabaseName("ix_course_discounts_course_id");

                    b.ToTable("course_discounts", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.CourseDiscount", b =>
                {
                    b.HasOne("Domain.Entities.Course", "Course")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_course_discounts_courses_course_id");
